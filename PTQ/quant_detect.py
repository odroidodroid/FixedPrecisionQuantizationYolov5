...
def run(
        ...
        source= '/home/youngjin/datasets/coco/test',  # file/dir/URL/glob, 0 for webcam
        ...
        project=ROOT / '../../runs/quant_detect',  # save results to project/name
        ...
        bit_width=8,
        mode='asymmetric',
        quantized_weight_save_path=ROOT / 'checkpoints',
):
    source = str(source)
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='/home/youngjin/datasets/coco/test', help='file/dir/URL/glob, 0 for webcam')
    ...
    parser.add_argument('--project', default=ROOT / '../../runs/quant_detect', help='save results to project/name')
